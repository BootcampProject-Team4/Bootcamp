const activitiesData = [
  ...
  },
  {
    ...
    endtime: "16:27",
    description:
      "The Marvels filmi, Carol Danvers, Kamala Khan ve Monica Rambeau'nun güçlerini birleştirerek evreni kurtarmak için birlikte çalışmasını konu alıyor. Filminin oyuncu kadrosunda Brie Larson, Iman Vellani, Teyonah Parris, Zawe Ashton, Samuel L. Jackson, Ben Mendelsohn ve Lashana Lynch yer alıyor.",
    PlaceId: 4,
    CategoryId: 1,
  },
  {
  ...
  },
  {
    ...
    endtime: "24:00",
    description:
      "Vakıfbank - Allianz Vero Volley MILANO (ITA) Voleybol Maçı Bileti. Spor müsabakalarında 6 yaş üzeri bilete tabiidir.",
    PlaceId: 6,
    CategoryId: 4,
  },
  {
    ...
    endtime: "23:00",
    description:
      "Arkas Spor - Neftohimik BURGAS (BUL) Voleybol Maçı Bileti. Spor müsabakalarında 6 yaş üzeri bilete tabiidir.",
    PlaceId: 9,
    CategoryId: 4,
  },
  {
  ...
  },
  {
    ...
    endtime: "22:00",
    description:
      "Boğaziçi Komedi Kulübü, yeni nesil komedyenlerle deneyimli komedyenlerin bir sahnede buluştuğu standup gecelerine devam ediyor! Her gösteride 5 farklı komedyenin sahne aldığı standup geceleri her Çarşamba Muaf Kadıköy sahnesinde!",
    PlaceId: 11,
    CategoryId: 6,
  },
  {
